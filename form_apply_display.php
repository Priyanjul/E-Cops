        ...
        <div class="container-fluid" style="background-color: black;">
            <div class="header row">
              <div class="logo span4">
                    <h1 style=" font-family: 'Press Start 2P', cursive;"> <a href="home.html" style="text-decoration:none; color: #ff6600;">E-Cops </a> </h1>
                </div>
...
<div style="background-color: #ff6600; height: 260px"><br>
</div><div style="position: relative; margin-top: -200px;">

       <center> <iframe name="Complaint" src="form_apply_main.php" width="55%"  height="800px" style="box-shadow: 5px 5px 5px rgba(1, 1, 1, 0.5);" 
